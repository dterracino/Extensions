...
namespace Genesys.Extras.Net
{
    ...
    public class HttpRequestPut<TDataIn, TDataOut> : HttpRequestPutString
    {
        ...
        /// Construct with data
        /// </summary>
        public HttpRequestPut(string url, TDataIn dataToSend) : base(url) { this.dataToSendStrong = dataToSend; base.DataToSend = this.Serializer.Serialize(dataToSend); }

        /// <summary>
        /// Construct with data
        /// </summary>
        public HttpRequestPut(string url, TDataIn dataToSend, IEncryptor encryptor) : this(url, dataToSend) { this.Encryptor = encryptor; }
        /// <summary>
        /// Construct with data
        /// </summary>
        public HttpRequestPut(string url, TDataIn dataToSend, List<Type> knownTypes) : this(url, dataToSend) { this.KnownTypes = knownTypes; }
